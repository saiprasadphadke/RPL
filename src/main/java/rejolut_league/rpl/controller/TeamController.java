...
public class TeamController {
    ...
    @PostMapping("/")
    public ResponseEntity<Object> registerTeam(@RequestBody TeamService.TeamRegister entity) {
        try {
    ...
    @PostMapping("/login")
    public ResponseEntity<Map<String, Object>> login(@RequestBody TeamService.LoginBody entity) {
